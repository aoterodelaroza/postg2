...
NAME=postg2
OBJS= promolmod.o param.o types.o tools.o eispack.o tools_math.o tools_linpack.o reader.o wfnmod.o meshmod.o io.o sandbox.o postg2.o 
LIBS=$(OBJECT_LIBXC)
...
sandbox/alpha.o sandbox.o wfnmod.o types.o tools_math.o tools.o reader.o promolmod.o postg2.o meshmod.o io.o : param.mod
postg2.o : promolmod.mod
postg2.o : reader.mod
sandbox.o wfnmod.o : tools.mod
tools_math.o meshmod.o : tools_linpack.mod
sandbox/atomicb.o reader.o promolmod.o postg2.o meshmod.o : tools_math.mod
