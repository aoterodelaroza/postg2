...
!> Linpack routines adapted from numol
module tools_linpack

  public
  ! LINPACK routines -- read the manual.
...
!
      ...
      DOUBLE PRECISION TNORM,YNORM,S,SM
...
!
      INTEGER I,II,J
      DOUBLE PRECISION A,ALPHA,AZETA,NORM
      DOUBLE PRECISION T,ZETA,B,XX
!
